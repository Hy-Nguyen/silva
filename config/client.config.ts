...
export const CLIENT_CONFIG: {
    ...
    data: {
        ...
        services: [
            {
                ...
                images: [
                    ...
                    'micheladas-tray.webp',
                    'micheladas-closeup.webp',
                ],
            },
            {
                icon: 'Calendar',
                ...
                price: 'From $25/guest',
                images: [
                    'shrimp-ceviche-tray-1.webp',
                    'mixed-seafood-tray-1.webp',
                    'mixed-seafood-tray-2.webp',
                    'shrimp-ceviche-tray-3.webp',
                ],
            },
        ...
        testimonials: [
            {
                quote: 'YOUR_QUOTE_1',
                name: 'YOUR_REVIEWER_1_NAME',
                meta: 'YOUR_REVIEWER_1_META',
                rating: 5,
            },
            {
                quote: 'YOUR_QUOTE_2',
                name: 'YOUR_REVIEWER_2_NAME',
                meta: 'YOUR_REVIEWER_2_META',
                rating: 5,
            },
            {
                quote: 'YOUR_QUOTE_3',
                name: 'YOUR_REVIEWER_3_NAME',
                meta: 'YOUR_REVIEWER_3_META',
                rating: 5,
            },
        ],
        ...
        images: {
            ...
            gallery: [
                ...
                'micheladas-tray.webp',
                'micheladas-closeup.webp',
                'cocktail-cups-kitchen.webp',
                'campechana.webp',
                'shrimp-ceviche-1.webp',
                // "shrimp-ceviche-tray-1.webp",
                'shrimp-aguachile-1.webp',
                'fish-tacos.webp',
                'octopus-aguachile-1.webp',
                'shrimp-ceviche-tray-2.webp',
                'shrimp-quesadillas-griddle.webp',
                'shrimp-quesadillas-plate.webp',
                'octopus-aguachile-2.webp',
                'mixed-seafood-cocktail.webp',
                'shrimp-pasta.webp',
                'octopus-ceviche.webp',
                // "mixed-seafood-tray-1.webp",
                // "shrimp-ceviche-tray-3.webp",
                'michelada-food-truck.webp',
                // "mixed-seafood-tray-2.webp",
            ],
...
export const STARTER_TEMPLATES: Record<ArchetypeKey, Archetype> = {
    ...
    salon: {
        ...
        sectionHeadings: {
            ...
            servicesSub:
                'Prices are starting points — we quote anything bigger before we begin.',
            gallery: 'Recent work.',
        ...
        services: [
            ...
            },
            {
                icon: 'Sparkles',
                title: 'Color',
                desc: 'YOUR_COLOR_DESC',
                price: 'From $XX',
            },
            {
                icon: 'Brush',
                title: 'Highlights',
                desc: 'YOUR_HIGHLIGHTS_DESC',
                price: 'From $XX',
            },
            {
                icon: 'Droplet',
                title: 'Treatment',
                desc: 'YOUR_TREATMENT_DESC',
                price: '$XX',
            },
            {
                icon: 'Heart',
                title: 'Bridal',
                desc: 'YOUR_BRIDAL_DESC',
                price: 'Quote',
            },
            {
                icon: 'User',
                title: 'First visit',
                desc: 'YOUR_FIRST_VISIT_DESC',
                price: '$XX',
            },
        ],
        galleryCaptions: [
    ...
    plumber: {
        ...
        sectionHeadings: {
            ...
            servicesSub:
                'Prices are starting points — we write a fixed quote before we touch anything.',
            gallery: 'Recent work.',
        ...
        services: [
            {
                icon: 'Droplet',
                title: 'YOUR_SERVICE_1',
                desc: 'YOUR_SERVICE_1_DESC',
                price: 'From $XXX',
            },
            {
                icon: 'Wrench',
                title: 'YOUR_SERVICE_2',
                desc: 'YOUR_SERVICE_2_DESC',
                price: 'From $XXX',
            },
            {
                icon: 'Flame',
                title: 'YOUR_SERVICE_3',
                desc: 'YOUR_SERVICE_3_DESC',
                price: 'Quote',
            },
            {
                icon: 'Shield',
                title: 'YOUR_SERVICE_4',
                desc: 'YOUR_SERVICE_4_DESC',
                price: 'Quote',
            },
            {
                icon: 'Sparkles',
                title: 'YOUR_SERVICE_5',
                desc: 'YOUR_SERVICE_5_DESC',
                price: 'From $XXX',
            },
            {
                icon: 'Phone',
                title: 'Emergency',
                desc: 'YOUR_EMERGENCY_DESC',
                price: '$XXX + work',
            },
        ],
        galleryCaptions: [
    ...
    taco: {
        ...
        sectionHeadings: {
            services: 'Where to find us.',
            servicesSub:
                'On a corner, at a brewery, or at your event — we keep it simple.',
            gallery: 'From the truck.',
            testimonials: 'What regulars say.',
            hours: 'This week.',
            contact: 'Find us or reach out.',
        ...
        services: [
            {
                icon: 'Truck',
                title: 'On the corner',
                desc: 'YOUR_LOCATION_AND_HOURS',
                price: '',
            },
            {
                icon: 'Calendar',
                title: 'Catering',
                desc: 'YOUR_CATERING_DESC',
                price: 'From $XX/guest',
            },
            {
                icon: 'Coffee',
                title: 'Pop-ups',
                desc: 'YOUR_POPUP_DESC',
                price: '',
            },
            {
                icon: 'Flame',
                title: 'YOUR_SPECIALTY',
                desc: 'YOUR_SPECIALTY_DESC',
                price: 'Quote',
            },
        ],
        galleryCaptions: [
        ...
        testimonials: [
            {
                quote: 'YOUR_QUOTE_1',
                name: 'YOUR_REVIEWER_1',
                meta: 'Regular since YEAR',
                rating: 5,
            },
            {
                quote: 'YOUR_QUOTE_2',
                name: 'YOUR_REVIEWER_2',
                meta: 'YOUR_CONTEXT',
                rating: 5,
            },
            {
                quote: 'YOUR_QUOTE_3',
                name: 'YOUR_REVIEWER_3',
                meta: 'YOUR_LOCATION',
                rating: 5,
            },
        ],
            ...
            categories: [
                {
                    ...
                    items: [
                        {
                            name: 'YOUR_ITEM_1',
                            desc: 'YOUR_ITEM_1_DESC',
                            price: '$X.XX',
                        },
                        {
                            name: 'YOUR_ITEM_2',
                            desc: 'YOUR_ITEM_2_DESC',
                            price: '$X.XX',
                        },
                    ],
                },
                {
                    ...
                    items: [
                        {
                            name: 'YOUR_ITEM_3',
                            desc: 'YOUR_ITEM_3_DESC',
                            price: '$XX',
                        },
                        {
                            name: 'YOUR_ITEM_4',
                            desc: 'YOUR_ITEM_4_DESC',
                            price: '$XX',
                        },
                    ],
                },
